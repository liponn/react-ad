...
// 红包分享
export const HONGBAO_LIST = 'ONEYUAN_LIST';
export const HONGBAO_OPERATION = 'ONEYUAN_OPERATION';
export const HONGBAO_ENABLE = 'ONEYUAN_ENABLE';
export const HONGBAO_DISABLE = 'ONEYUAN_DISABLE';
export const HONGBAO_DEL = 'ONEYUAN_DEL';
