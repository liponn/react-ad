...
import { INFOLINK_LIST, MYSERVICE_DEL, MYSERVICE_DISABLE, MYSERVICE_ENABLE, MYSERVICE_UP, MYSERVICE_DOWN, MYSERVICE_ADD, MYSERVICE_PUT } from '../../../constants';
...
export default connect(state => {
  const { omg } = state;
  const banners = omg[INFOLINK_LIST] || {};
  return {
    banners,
  };
})(InfoLink);
