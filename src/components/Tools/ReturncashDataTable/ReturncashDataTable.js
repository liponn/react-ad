...
class ReturncashDataTable extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                <div className="card clearfix">
                  ...
                  ({this.state.start + items.length}/{filterNum})
                            ...
                            <div>
                                <button
                                    onClick={this.handleBatchSend.bind(this)}
                                    className="btn btn-success-outline pull-left m-l-1"
                                >全部发送
                                </button>
                            </div>
                            : ''}
                    ...
                    <table className="table table-bordered m-b-0 table-hover data-table">
                        ...
                        {items.map((item, index) => {
                            ...
                            return (<tr key={`item_${index}`}>
                                ...
                                : <td><button className="btn btn-info-outline btn-sm disabled">{item[4] == 1 ? '处理中' : '已发送'}</button></td>}
                            </tr>);
                        })}
                        </tbody>
                    </table>
...
ReturncashDataTable.defaultProps = {
    title: '列表',
}
